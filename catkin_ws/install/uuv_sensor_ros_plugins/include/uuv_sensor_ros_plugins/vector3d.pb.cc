...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Vector3d_vector3d_2eproto =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_vector3d_2eproto = {
  false, false, descriptor_table_protodef_vector3d_2eproto, "vector3d.proto", 74,
...
static bool dynamic_init_dummy_vector3d_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_vector3d_2eproto)), true);
namespace gazebo {
namespace msgs {
...
Vector3d::Vector3d(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:gazebo.msgs.Vector3d)
}
...
template<> PROTOBUF_NOINLINE ::gazebo::msgs::Vector3d* Arena::CreateMaybeMessage< ::gazebo::msgs::Vector3d >(Arena* arena) {
  return Arena::CreateMessageInternal< ::gazebo::msgs::Vector3d >(arena);
}
