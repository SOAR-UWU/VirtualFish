...
: ${AMENT_CURRENT_PREFIX:="/home/sunny/catkin_ws/install/uuv_sensor_ros_plugins"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/uuv_sensor_ros_plugins/environment/library_path.sh"
