...
static const _GoTo_Request_type_support_symbol_names_t _GoTo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, GoTo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uuv_control_msgs, srv, GoTo_Request)),
  }
};
...
{
  return &::uuv_control_msgs::srv::rosidl_typesupport_cpp::GoTo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uuv_control_msgs, srv, GoTo_Request)() {
  return get_message_type_support_handle<uuv_control_msgs::srv::GoTo_Request>();
}
...
static const _GoTo_Response_type_support_symbol_names_t _GoTo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, GoTo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uuv_control_msgs, srv, GoTo_Response)),
  }
};
...
{
  return &::uuv_control_msgs::srv::rosidl_typesupport_cpp::GoTo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uuv_control_msgs, srv, GoTo_Response)() {
  return get_message_type_support_handle<uuv_control_msgs::srv::GoTo_Response>();
}
...
static const _GoTo_type_support_symbol_names_t _GoTo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, GoTo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uuv_control_msgs, srv, GoTo)),
  }
};
...
{
  return &::uuv_control_msgs::srv::rosidl_typesupport_cpp::GoTo_service_type_support_handle;
}
