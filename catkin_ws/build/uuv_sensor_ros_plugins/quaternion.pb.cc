...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Quaternion_quaternion_2eproto =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_quaternion_2eproto = {
  false, false, descriptor_table_protodef_quaternion_2eproto, "quaternion.proto", 89,
...
static bool dynamic_init_dummy_quaternion_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_quaternion_2eproto)), true);
namespace gazebo {
namespace msgs {
...
Quaternion::Quaternion(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:gazebo.msgs.Quaternion)
}
...
template<> PROTOBUF_NOINLINE ::gazebo::msgs::Quaternion* Arena::CreateMaybeMessage< ::gazebo::msgs::Quaternion >(Arena* arena) {
  return Arena::CreateMessageInternal< ::gazebo::msgs::Quaternion >(arena);
}
