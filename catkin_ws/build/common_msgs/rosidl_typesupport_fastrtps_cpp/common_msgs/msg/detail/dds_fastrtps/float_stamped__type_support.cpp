...
#include "common_msgs/msg/detail/float_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = common_msgs::msg::FloatStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const common_msgs::msg::FloatStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<common_msgs::msg::FloatStamped *>(
    untyped_ros_message);
...
{
  return &common_msgs::msg::typesupport_fastrtps_cpp::_FloatStamped__handle;
}
