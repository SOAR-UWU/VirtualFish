...
class Thruster(Node):
    def __init__(self, node_name: str, id: int):
        ...
        self.thruster_publisher_ = self.create_publisher(FloatStamped, "thrusters/id_" + str(id) + '/input', 10)
...
class ThrusterManagerNode(Node):
    def __init__(self):
        ...
        self.thrusters = [Thruster(f'thrusters_id_{i}', i) for i in range(self.num_thrusters)]
